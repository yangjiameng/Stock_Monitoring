...
class Ui_Stock_Monitoring(object):
    def setupUi(self, Stock_Monitoring):
        ...
        Stock_Monitoring.resize(784, 564)
        ...
        self.gridLayout.addWidget(self.pushButton_search, 3, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.graphicsView_daily_line, 2, 1, 1, 1)
