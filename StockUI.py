...
class Ui_Stock_Monitoring(object):
    def setupUi(self, Stock_Monitoring):
        ...
        self.gridLayout.addWidget(self.dateEdit_end, 4, 3, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.label_buy3, 2, 2, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.progressBar_4, 3, 1, 1, 1)
        self.progressBar_5 = QtWidgets.QProgressBar(self.groupBox_2)
        self.progressBar_5.setMaximumSize(QtCore.QSize(16777215, 3))
        self.progressBar_5.setProperty("value", 60)
        self.progressBar_5.setTextVisible(False)
        self.progressBar_5.setObjectName("progressBar_5")
        self.gridLayout_8.addWidget(self.progressBar_5, 4, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.label_buy2, 1, 2, 1, 1)
        self.label_buy1 = QtWidgets.QLabel(self.groupBox_2)
        self.label_buy1.setObjectName("label_buy1")
        self.gridLayout_8.addWidget(self.label_buy1, 0, 2, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.progressBar_3, 2, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.progressBar_2, 1, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.label_buy4, 3, 2, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.label_buy5, 4, 2, 1, 1)
        self.progressBar_6 = QtWidgets.QProgressBar(self.groupBox_2)
        self.progressBar_6.setMaximumSize(QtCore.QSize(16777215, 3))
        self.progressBar_6.setProperty("value", 50)
        self.progressBar_6.setTextVisible(False)
        self.progressBar_6.setObjectName("progressBar_6")
        self.gridLayout_8.addWidget(self.progressBar_6, 0, 3, 1, 1)
        self.progressBar_7 = QtWidgets.QProgressBar(self.groupBox_2)
        self.progressBar_7.setMaximumSize(QtCore.QSize(16777215, 3))
        self.progressBar_7.setProperty("value", 50)
        self.progressBar_7.setTextVisible(False)
        self.progressBar_7.setObjectName("progressBar_7")
        self.gridLayout_8.addWidget(self.progressBar_7, 1, 3, 1, 1)
        self.progressBar_8 = QtWidgets.QProgressBar(self.groupBox_2)
        self.progressBar_8.setMaximumSize(QtCore.QSize(16777215, 3))
        ...
        self.gridLayout_8.addWidget(self.progressBar_8, 2, 3, 1, 1)
        self.progressBar_9 = QtWidgets.QProgressBar(self.groupBox_2)
        self.progressBar_9.setMaximumSize(QtCore.QSize(16777215, 3))
        ...
        self.gridLayout_8.addWidget(self.progressBar_9, 3, 3, 1, 1)
        self.progressBar_10 = QtWidgets.QProgressBar(self.groupBox_2)
        self.progressBar_10.setMaximumSize(QtCore.QSize(16777215, 3))
        ...
        self.gridLayout_8.addWidget(self.progressBar_10, 4, 3, 1, 1)
    ...
    def retranslateUi(self, Stock_Monitoring):
        ...
        self.label_sell2.setText(_translate("Stock_Monitoring", "卖2    40"))
        self.label_buy3.setText(_translate("Stock_Monitoring", "买3"))
        self.label_sell4.setText(_translate("Stock_Monitoring", "卖4"))
        self.label_buy2.setText(_translate("Stock_Monitoring", "买2"))
        self.label_buy1.setText(_translate("Stock_Monitoring", "买1"))
        self.label_sell3.setText(_translate("Stock_Monitoring", "卖3"))
        self.label_sell5.setText(_translate("Stock_Monitoring", "卖5"))
        self.label_sell1.setText(_translate("Stock_Monitoring", "卖1    50"))
        self.label_buy4.setText(_translate("Stock_Monitoring", "买4"))
        self.label_buy5.setText(_translate("Stock_Monitoring", "买5"))
