...
class Ui_Stock_Monitoring(object):
    def setupUi(self, Stock_Monitoring):
        ...
        self.graphicsView_daily_line = GraphicsLayoutWidget(self.centralwidget)
        self.graphicsView_daily_line.setObjectName("graphicsView_daily_line")
        self.gridLayout_3.addWidget(self.graphicsView_daily_line, 4, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.listWidget_show_msg, 2, 2, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.graphicsView_matplot, 4, 2, 1, 2)
    ...
    def retranslateUi(self, Stock_Monitoring):
        ...
        self.lineEdit_4.setText(_translate("Stock_Monitoring", "20210816"))
